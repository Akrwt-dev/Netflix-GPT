...
const Login=()=>{
    ...
    return(
        <div>
            ...
            <img src="https://assets.nflxext.com/ffe/siteui/vlv3/258d0f77-2241-4282-b613-8354a7675d1a/web/IN-en-20250721-TRIFECTA-perspective_cadc8408-df6e-4313-a05d-daa9dcac139f_small.jpg"alt="background-img"></img>
            </div>
            {/* on submit to prevent the default functionality of submite button and ref={} to provide refrence */}
            <form onSubmit={(e)=>e.preventDefault()} className="absolute w-3/12 p-12 bg-black mx-auto my-36 right-0 left-0 text-white rounded-lg bg-opacity-85">
                
                <h1 className="font-bold text-3xl p-4">{isSignInForm ? "Sign In":"Sign Up"}</h1>

                {!isSignInForm && (<input ref={name} type="text" placeholder="Full Name" className="p-4 my-4 w-full bg-gray-700 rounded-lg"></input>)}
                
                <input ref={email} type="text" placeholder="Email Address" className="p-4 my-4 w-full bg-gray-700 rounded-lg"></input>
                ...
                <button onClick={handleButtonClick} className="p-4 my-6 mx-2 bg-red-500 w-full rounded-lg">{isSignInForm ? "Sign In":"Sign Up"}</button>
